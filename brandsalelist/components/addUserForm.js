...
export default function AddUserForm(){
    ...
    <button  className="flex justify-center text-md w-3/6 bg-green-500 text-white border rounded-md">Add <span className="px-1"><BiPlus size={24}></BiPlus></span></button>
    </form>
    )
 }